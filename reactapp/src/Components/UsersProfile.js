...
function UsersProfile() {
    useEffect(() => {
        document.title = "TravelYaari  ||  UserProfile";
      }, [])
    ...
    const handleShow = (id) => {
        ...
        setShow(true);
        axios.get(`https://8080-ebadadfaceebbeceffbfcffabcbabdadaaeecfcabcb.examlyiopb.examly.io/getUserById/${id}`, {
            headers: {
    ...
    const EditSubmit = (userid) => {
        ...
        axios.put(`https://8080-ebadadfaceebbeceffbfcffabcbabdadaaeecfcabcb.examlyiopb.examly.io/updateUserById/${userid}`,userDetails,{
            headers: {
              Authorization: localStorage.getItem("token")
            }
          }).then((response) => {
    ...
    const onClickDelete = async (data) => {
        if (window.confirm('Are you sure?')) {
            axios.delete(`https://8080-ebadadfaceebbeceffbfcffabcbabdadaaeecfcabcb.examlyiopb.examly.io/deleteUserById/${data}`, {
                headers: {
                    Authorization: localStorage.getItem("token")
                }
            }
    ...
    useEffect(() => {
        axios.get("https://8080-ebadadfaceebbeceffbfcffabcbabdadaaeecfcabcb.examlyiopb.examly.io/allUsers", {
            headers: {
              Authorization: localStorage.getItem("token")
            }
          }).then((res) => {
