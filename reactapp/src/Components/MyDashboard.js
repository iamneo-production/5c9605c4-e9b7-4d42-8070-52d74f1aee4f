...
function MyDashboard() {
    ...
    useEffect(() => {
        axios.get(`https://8080-decaafdbcaceffbfcffabcbabdadaaeecfcabcb.examlyiopb.examly.io/admin/getVehicleById/${busid}`).then((response) => {
...
//console.log(busdetails);
    ...
    return <div id="mybooking">
        <UserDashboard />
        <Card id='bookcard' style={{ backgroundColor: '#202020', color: 'white', opacity: '0.8' }}>
            <Formik initialValues={initialValues}
                validationSchema={validationSchema}
                onSubmit={onSubmit}>
                <Form>

                    <label htmlFor='vehicleName' style={{ color: 'white', marginTop: '5%' }}>Vehicle Name</label>
                    ...
                    <label htmlFor='vehicleFrom' style={{ color: 'white' }}>From place</label>
                    <div className="col-sm-6" >
                        <Field
                            type='text'
                            id='vehicleFrom'
                    ...
                    <label htmlFor='vehicleTo' style={{ color: 'white' }}>To place</label>
                    <div className="col-sm-6" >
                        <Field
                            type='text'
                            id='vehicleTo'
                    ...
                    <label htmlFor='price' style={{ color: 'white' }}>Price per head</label>
                    <div className="col-sm-6">
                        <Field
                            type='text'
                            id='price'
                    ...
                    <label htmlFor='fillFromDate' style={{ color: 'white' }}>Date</label>
                    <div className="col-sm-6">
                        <Field
                            type='Date'
                            id='fillFromDate'
                    ...
                    <label htmlFor='enterNoTicket' style={{ color: 'white' }}>No.of person</label>
                    <div className="col-sm-6">
                        <Field
                            type='text'
                            as='select'
                  ...
                  <div>
                    ...
                    <button type='submit' className='btn btn-success' id='addButton' >Book</button>
                    <ToastContainer />
