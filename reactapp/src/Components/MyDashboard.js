...
function MyDashboard() {
    ...
    const onSubmit = async (data, onSubmitProps) => {
        ...
        console.log(data1);
        axios.post(`https://8080-ebadadfaceebbeceffbfcffabcbabdadaaeecfcabcb.examlyiopb.examly.io/addBooking/`, data1, {
            headers: {
    ...
    useEffect(() => {
        axios.get(`https://8080-ebadadfaceebbeceffbfcffabcbabdadaaeecfcabcb.examlyiopb.examly.io/getVehicleById/${busid}`, {
            headers: {
                Authorization: localStorage.getItem("token"),
            }
        }).then((response) => {
    ...
    for (let i = 1; i <= passengers; i++) {
        ...
        fields.push(
            ...
            <div className="col-sm-6" key={i}>
                ...
                <select className="form-select" placeholder="Select Gender" style={{ marginTop: '15px' }} required={true}>
